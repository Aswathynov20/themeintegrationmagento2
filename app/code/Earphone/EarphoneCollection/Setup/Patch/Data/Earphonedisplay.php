<?php
namespace Earphone\EarphoneCollection\Setup\Patch\Data;
...
class Earphonedisplay implements DataPatchInterface, PatchVersionInterface
{
    /**
    ...
    public function apply()
    {
        ...
        $cmsBlockData = [
            'title' => 'Earphone Slider Block',
            'identifier' => 'Earphone Slider Block',
            'content' => '{{block class="Magento\Framework\View\Element\Template"
            template="Earphone_EarphoneCollection::earphone.phtml"}}',
            'is_active' => 1,
            'stores' => [0],
            'sort_order' => 50
        ];
