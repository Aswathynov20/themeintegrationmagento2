<?php
namespace Menshoes\ProductShoes\Setup\Patch\Data;
...
class Productdisplay implements DataPatchInterface, PatchVersionInterface
{
    /**
    ...
    public function apply()
    {
        ...
        $cmsBlockData = [
            'title' => 'Product Slider Block',
            'identifier' => 'Product Slider Block',
            'content' => '{{block class="Magento\Framework\View\Element\Template"
            template="Menshoes_ProductShoes::product.phtml"}}',
            'is_active' => 1,
            'stores' => [0],
            'sort_order' => 40
        ];
